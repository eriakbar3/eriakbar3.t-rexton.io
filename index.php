...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body class="" style="padding-top:0px;">
        <!-- Login -->
        <form class="login-content" action="proses-login.php" method="post" style="background-color:#edecec">
          <div class="lc-block toggled" id="l-login">
              ...
              <input type="submit" class="btn btn-block btn-primary btn-float m-t-25" value="Sign In">
